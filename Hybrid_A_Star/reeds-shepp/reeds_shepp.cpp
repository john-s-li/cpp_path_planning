...
ReedsSheppStateSpace::path_types ReedsSheppStateSpace::type(double q0[3], double q1[3]) {
  path_types types;
...
ReedsSheppStateSpace::sample_paths ReedsSheppStateSpace::sample(double q0[3], double q1[3], 
                                          double step_size) {
  ...
  for (double seg = 0.0; seg <= dist; seg += step_size){
    vector<double> qnew = {0.0, 0.0, 0.0};
